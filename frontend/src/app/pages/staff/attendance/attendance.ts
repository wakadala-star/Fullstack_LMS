  ...
  template: `
    <div class="space-y-6">
      ...
      <div>
        ...
        <p class="mt-1 text-sm text-gray-500">Track your attendance and participation</p>
      </div>
      ...
      <div class="grid grid-cols-2 gap-4 lg:grid-cols-4">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          ...
          <p class="mt-1 text-2xl font-bold text-blue-600">22 / 24</p>
          <p class="text-xs text-gray-400 mt-1">Days present</p>
        </div>
        <div class="rounded-xl border border-gray-200 bg-white p-5 shadow-sm">
          <p class="text-sm font-medium text-gray-500">Overall Rate</p>
          <p class="mt-1 text-2xl font-bold text-purple-600">96%</p>
      ...
      <div class="rounded-xl border-2 border-dashed border-gray-300 bg-white p-12 text-center">
        ...
        <p class="mt-2 text-sm text-gray-500 max-w-md mx-auto">
          Audio and video classroom sessions will be available here soon. You'll be able to join live classes, 
          participate in real-time, and automatically track attendance.
        </p>
      ...
      <div class="rounded-xl border border-gray-200 bg-white shadow-sm overflow-hidden">
        <div class="p-5 border-b border-gray-100">
          <h3 class="text-sm font-semibold text-gray-900">Recent Attendance</h3>
        </div>
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              @for (record of recentRecords(); track record.date) {
...
export class StaffAttendanceComponent {
  protected readonly recentRecords = signal([
    { date: 'Jul 21, 2026', day: 'Monday', present: true, timeIn: '08:00 AM' },
    { date: 'Jul 18, 2026', day: 'Friday', present: true, timeIn: '07:55 AM' },
    { date: 'Jul 17, 2026', day: 'Thursday', present: true, timeIn: '08:02 AM' },
    { date: 'Jul 16, 2026', day: 'Wednesday', present: true, timeIn: '07:58 AM' },
    { date: 'Jul 15, 2026', day: 'Tuesday', present: true, timeIn: '08:01 AM' },
    { date: 'Jul 14, 2026', day: 'Monday', present: false, timeIn: '-' },
  ]);
}
